...
cp "ELPE.icns" "nextstep/Emacs.app/Contents/Resources/Emacs.icns"
xattr -cr nextstep/Emacs.app

sed 's|<string>26.0.50</string>|<string>'$build_number'</string>|g;
s|<string>org.gnu.Emacs</string>|<string>ca.busfactor1.emacs</string>|g;
...
s|^</dict>|<key>LSApplicationCategoryType</key><string\>public.app-category.developer-tools</string>\
